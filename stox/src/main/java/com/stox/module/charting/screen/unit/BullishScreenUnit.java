...
public class BullishScreenUnit extends AbstractScreenUnit {

	public BullishScreenUnit(final Group parent) {
		super(Icon.ARROW_UP, "bullish", parent);
	}
	...
	public void update(int index, ScreenMatch model, ScreenMatch previousModel, XAxis xAxis, YAxis yAxis) {
		...
		final double y = yAxis.getY(bar.low()) + 5 + height;
