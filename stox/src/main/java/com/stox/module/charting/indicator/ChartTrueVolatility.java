...
import com.stox.module.indicator.TrueVolatility;
...
public class ChartTrueVolatility extends AbstractChartIndicator<Config, Double, Point2D> {

	@Delegate
	private final Indicator<Config, Double> indicator = Indicator.ofType(TrueVolatility.class);
