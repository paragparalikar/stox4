...
public class ScreenerTitleBar extends ModuleTitleBar {
	...
	private RankerConfigEditorModal screenerConfigEditorModal;
	...
	private void configEditor() {
		Optional.ofNullable(screenerConfigEditorModal)
			.orElseGet(() -> screenerConfigEditorModal = new RankerConfigEditorModal(messageSource, scripsSupplierViewSuppliers))
			.show(getNode());
	}
